...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-generator-jhipster/node_modules/generator-jhipster/generators/client/files-angular.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-generator-jhipster/node_modules/generator-jhipster/generators/client/files-angular.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-generator-jhipster/node_modules/generator-jhipster/generators/client/</a> &#187; files-angular.js</div>
</div>
<div class="body">
...
485
486
487</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const mkdirp = require('mkdirp');
...
const files = {
    ...
    css: [
        ...
        {
            condition: generator =&gt; <span class="cstat-no" title="statement not covered" >!generator.useSass,</span>
            path: MAIN_SRC_DIR,
            templates: [
    ...
    angularApp: [
        ...
        {
            condition: generator =&gt; <span class="cstat-no" title="statement not covered" >generator.authenticationType === 'oauth2' || generator.authenticationType === 'jwt' || generator.authenticationType === 'uaa',</span>
            path: ANGULAR_DIR,
            templates: [
        ...
        {
            condition: generator =&gt; <span class="cstat-no" title="statement not covered" >!generator.skipServer,</span>
            path: ANGULAR_DIR,
            templates: [
    ...
    angularMain: [
        ...
        {
            condition: generator =&gt; <span class="cstat-no" title="statement not covered" >generator.enableTranslation,</span>
            path: ANGULAR_DIR,
            templates: [
    ...
    angularAccountModule: [
        ...
        {
            condition: generator =&gt; <span class="cstat-no" title="statement not covered" >generator.authenticationType === 'session',</span>
            path: ANGULAR_DIR,
            templates: [
        ...
        {
            condition: generator =&gt; <span class="cstat-no" title="statement not covered" >generator.enableSocialSignIn,</span>
            path: ANGULAR_DIR,
            templates: [
        ...
        {
            condition: generator =&gt; <span class="cstat-no" title="statement not covered" >generator.enableSocialSignIn &amp;&amp; generator.authenticationType === 'jwt',</span>
            path: ANGULAR_DIR,
            templates: [
    ...
    angularAdminModule: [
        ...
        {
            condition: generator =&gt; <span class="cstat-no" title="statement not covered" >generator.devDatabaseType !== 'cassandra',</span>
            path: ANGULAR_DIR,
            templates: [
        ...
        {
            condition: generator =&gt; <span class="cstat-no" title="statement not covered" >generator.websocket === 'spring-websocket',</span>
            path: ANGULAR_DIR,
            templates: [
        ...
        {
            condition: generator =&gt; <span class="cstat-no" title="statement not covered" >!generator.skipUserManagement,</span>
            path: ANGULAR_DIR,
            templates: [
        ...
        {
            condition: generator =&gt; <span class="cstat-no" title="statement not covered" >generator.applicationType === 'gateway',</span>
            path: ANGULAR_DIR,
            templates: [
    ...
    angularAuthService: [
        ...
        {
            condition: generator =&gt; <span class="cstat-no" title="statement not covered" >generator.authenticationType === 'oauth2',</span>
            path: ANGULAR_DIR,
            templates: [
        ...
        {
            condition: generator =&gt; <span class="cstat-no" title="statement not covered" >generator.authenticationType === 'jwt' || generator.authenticationType === 'uaa',</span>
            path: ANGULAR_DIR,
            templates: [
    ...
    clientTestFw: [
        ...
        {
            condition: generator =&gt; <span class="cstat-no" title="statement not covered" >generator.protractorTests,</span>
            path: TEST_SRC_DIR,
            templates: [
...
<span class="cstat-no" title="statement not covered" >    mkdirp(MAIN_SRC_DIR);</span>
    // write angular 2.x and above files
<span class="cstat-no" title="statement not covered" >    this.writeFilesToDisk(files, this, false, 'angular');</span>
}
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
